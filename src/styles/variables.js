...
const sizingVar = {
  // Font Size
  minFontSize: ms(1, msOption).toFixed(3), // 1.125
  maxFontSize: ms(4, msOption).toFixed(3), // 1.333
  ...
  'ms-9': ms(-9, msOption).toFixed(3), // .422
  'ms-8': ms(-8, msOption).toFixed(3), // .475
  'ms-7': ms(-7, msOption).toFixed(3), // .528
  ...
  ms24: ms(24, msOption).toFixed(3), // 9.969 D2
  ms25: ms(25, msOption).toFixed(3), // 11.215
  ...
  ms32: ms(32, msOption).toFixed(3), // 22.142
...
export { sizingVar, screensVar, measuresVar, reusableCssProperties };
